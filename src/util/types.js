...
export const LINE_ITEM_ADDON_FEE = 'line-item/addon-fee';
export const LINE_ITEM_ADDON_FEE_1 = 'line-item/addon-fee_1';
export const LINE_ITEM_ADDON_FEE_2 = 'line-item/addon-fee_2';
...
export const LINE_ITEMS = [
  ...
  LINE_ITEM_UNITS,
  LINE_ITEM_ADDON_FEE,
  LINE_ITEM_ADDON_FEE_1,
  LINE_ITEM_ADDON_FEE_2,
