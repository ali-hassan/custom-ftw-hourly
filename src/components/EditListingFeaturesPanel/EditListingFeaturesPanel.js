...
const EditListingFeaturesPanel = props => {
  ...
  const hours = publicData && publicData.hours;
  const serialNumber = publicData && publicData.serialNumber;

  const initialValues = { year, hours, serialNumber };
  ...
  return (
    <div className={classes}>
      ...
      <EditListingFeaturesForm
        ...
        onSubmit={values => {
          const { year, hours, serialNumber } = values;

          const updatedValues = {
            publicData: { year, hours, serialNumber },
          };
