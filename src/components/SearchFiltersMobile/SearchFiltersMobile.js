...
class SearchFiltersMobileComponent extends Component {
  ...
  handleSelectSingle(urlParam, option) {
    ...
    if(urlParam == 'pub_category') {
      updatedQueryParams = omit(updatedQueryParams, 'pub_sub_category');
      updatedQueryParams = omit(updatedQueryParams, 'pub_size');
    }

    if (urlParam == 'pub_sub_category') {
      updatedQueryParams = omit(updatedQueryParams, 'pub_size');
    }

    history.push(createResourceLocatorString('SearchPage', routeConfiguration(), {}, updatedQueryParams));
  }
  ...
  render() {
    ...
    const subCategoryLabel = intl.formatMessage({
      id: 'SearchFiltersMobile.subCategoryLabel',
    });
    const initialSubCategory = subCategoryFilter ? this.initialValue(subCategoryFilter.paramName) : null;
    ...
    const sizeLabel = intl.formatMessage({
      id: 'SearchFiltersMobile.sizeLabel',
    });
    const initialSize = sizeFilter ? this.initialValue(sizeFilter.paramName) : null;
