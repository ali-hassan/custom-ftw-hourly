...
const tabLabel = (intl, tab) => {
  ...
  // }
    ...
    key = 'EditListingWizard.tabLabelTransportation';
...
const tabCompleted = (tab, listing) => {
  ...
  switch (tab) {
    case DESCRIPTION:
      return !!(description && title && publicData.category && publicData.model && publicData.size);
    case FEATURES:
      return !!(publicData && publicData.year && publicData.hours && publicData.serialNumber);
    //case POLICY:
    ...
    case PHOTOS:
      return images && images.length > 0 && privateData.termsAndConditionsAccepted === 'accepted';
    default:
      return false;
  }
};
