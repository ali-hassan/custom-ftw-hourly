  ...
  return (
    <StaticPage
      ...
      schema={{
        ...
        '@type': 'AboutPage',
        description: 'About EqpMe Marketplace',
        name: 'About page',
      }}
    >
      <LayoutSingleColumn>
        ...
        <LayoutWrapperMain className={css.staticPageWrapper}>
          <h1 className={css.pageTitle}>Experience a new way to rent machinery.</h1>
          <img className={css.coverImage} src={image} alt="My first ice cream." />

          <div className={css.contentWrapper}>
            <div className={css.contentSide}>
              <p>Did you know the average EpqMe customer save 20% when using our marketplace instead of traditinal rental companies!</p>
            </div>
