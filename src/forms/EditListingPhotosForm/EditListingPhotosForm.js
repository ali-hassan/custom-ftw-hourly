...
import { AddImages, Button, Form, FieldCheckbox, ValidationError } from '../../components';
    ...
    return (
      <FinalForm
        ...
        render={formRenderProps => {
          ...
          const termsAndConditionsAcceptRequiredMessage = intl.formatMessage({
            id: 'EditListingPhotosForm.termsAndConditionsAcceptRequired',
          });
          ...
          const termsAndConditionsAcceptMessage = intl.formatMessage({
            id: 'EditListingPhotosForm.termsAndConditionsAcceptText',
          });
          ...
          return (
            ...
            >
              ...
              <div className={css.termsAndConditions}>
                <FieldCheckbox
                  className={css.termsAndConditionsLabel}
                  id={'listing.termsAndConditionsAccepted'}
                  label={<FormattedMessage
                    id="EditListingPhotosForm.termsAndConditionsAcceptText"
                    values={{ termsLink }} />}
                  name={'termsAndConditionsAccepted'}
                  validate={composeValidators(required(termsAndConditionsAcceptRequiredMessage))}
                  value={'accepted'}
                />
              </div>
