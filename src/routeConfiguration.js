...
const routeConfiguration = () => {
  return [
    ...
    },
    {
      path: '/insurance',
      name: 'InsurancePage',
      component: props => <InsurancePage {...props} />,
    },
    {
      path: '/equipment-we-accept',
      name: 'EquipmentAcceptPage',
      component: props => <EquipmentAcceptPage {...props} />,
    },
    {
      path: '/cancellations',
      name: 'CancellationsPage',
      component: props => <CancellationsPage {...props} />,
    },
    {
      path: '/premium-vendor',
      name: 'PremiumVendorsPage',
      component: props => <PremiumVendorsPage {...props} />,
    },
